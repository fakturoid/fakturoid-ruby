...
class Fakturoid::Api::InventoryMoveTest < Fakturoid::TestCase
  should "get all" do
    ...
    assert_equal 1, test_client.inventory_move.all.body.size
  end
  ...
  should "get all for single inventory item" do
    ...
    assert_equal 1, test_client.inventory_move.all(inventory_item_id: 1).body.size
  end
  ...
  should "get detail" do
    ...
    assert_equal 2, test_client.inventory_move.find(1, 2).id
  end
  ...
  should "create new record" do
    ...
    assert_equal 2, test_client.inventory_move.create(1, direction: "out", moved_on: Date.today, quantity_change: 1).id
  end
  ...
  should "update record" do
    ...
    assert_equal 2, test_client.inventory_move.update(1, 2, moved_on: Date.today + 1).id
  end
  ...
  should "delete record" do
    ...
    assert_equal 204, test_client.inventory_move.delete(1, 2).status_code
  end
end
