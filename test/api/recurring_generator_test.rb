...
class Fakturoid::Api::RecurringGeneratorTest < Fakturoid::TestCase
  should "get all" do
    ...
    assert_equal 1, test_client.recurring_generator.all.body.size
  end
  ...
  should "get detail" do
    ...
    assert_equal 1, test_client.recurring_generator.find(1).id
  end
  ...
  should "create new record" do
    ...
    assert_equal 1, test_client.recurring_generator.create(data).id
  end
  ...
  should "update record" do
    ...
    assert_equal 1, test_client.recurring_generator.update(1, name: "Longer workshop").id
  end
  ...
  should "delete record" do
    ...
    assert_equal 204, test_client.recurring_generator.delete(1).status_code
  end
end
