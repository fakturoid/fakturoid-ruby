...
class Fakturoid::Api::InvoicePaymentTest < Fakturoid::TestCase
  should "create new record" do
    ...
    assert_equal 1, test_client.invoice_payment.create(1, paid_on: Date.today).id
  end
  ...
  should "create tax document" do
    ...
    assert_equal 1, test_client.invoice_payment.create_tax_document(1, 2).id
  end
  ...
  should "delete record" do
    ...
    assert_equal 204, test_client.invoice_payment.delete(1, 2).status_code
  end
end
